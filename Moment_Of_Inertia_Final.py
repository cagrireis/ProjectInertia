    ...
    if (giris == "g"):
        ...
        if (giris2 == "a"):
            ...
            for k in range(0, obje_sayisi_1):
                if (len(alansırası[k]) == 7):
                    IXX = IXX + (alansırası[k][5] + alansırası[k][0] * (alansırası[k][4] - Yg) ** 2)
                    IYY = IYY + (alansırası[k][5] + alansırası[k][0] * (alansırası[k][3] - Xg) ** 2)
                    IXXYY = IXXYY + (alansırası[k][6] + alansırası[k][0] * (alansırası[k][3] - Xg) * (alansırası[k][4] - Yg))
                else:
                    IXX = IXX + (alansırası[k][5] + alansırası[k][0] * (alansırası[k][4] - Yg) ** 2)
                    IYY = IYY + (alansırası[k][5] + alansırası[k][0] * (alansırası[k][3] - Xg) ** 2)
                    IXXYY = IXXYY + (alansırası[k][0] * (alansırası[k][3] - Xg) * (alansırası[k][4] - Yg))
